...
var layout = {
      ...
      yaxis: {rangemode: 'tozero',
          ...
          ticks: '',
          showticklabels: true,
          tickfont: {color: 'rgb(50,86,135)',
                    family: 'Rajdhani, serif',
                    size: 14,},
          linecolor: 'rgb(50,86,135)',
          linewidth: 3,
          title: 'Aim Lab',
          titlefont: {
            family: 'Rajdhani, serif',
...
function pageloaded() {
  var button_clicked = document.getElementById("pageload_button");
  button_clicked.className = "button is-white has-text-info is-small is-white"
}
...
function update_spidershot() {
    ...
    loading_spidershot()
    var jsonData = $.ajax({
        url: window.location.href.replace("tb_profile", "tb_metric"),
        dataType: 'json',
        data: {
            taskname: 'spidershot',
...
//     var jsonData = $.ajax({
//         url: window.location.href.replace("tb_profile", "tb_profile_json"),
//         dataType: 'json',
//         data: {
//             taskname: 'spidershot',
//             mode: '0'
